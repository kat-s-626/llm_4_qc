...
# data paths
export non_parameterized_set_dir="$data/non_parametric_sets"
export parameterized_set_dir="$data/parametric_sets"
export grover_gpt_replication_dir="$data/grover_gpt_replication"
export results_dir="$data/results"
export train_10_20="$non_parameterized_set_dir/sft_datasets/train_filtered_by_gate_count_10_20.parquet"
export non_parameterized_set_grpo="$non_parameterized_set_dir/grpo_datasets"

# model paths
export qwen_8b_special_sft_model_non_parameterized="$project_root/verl/merged_models/non_parametric_set_sft_17500/qwen3_8b_special"
export qwen_8b_special_sft_model_parameterized="$project_root/verl/merged_models/parametric_set_sft_17500/qwen3_8b_special"
