...
def compute_score(data_source: Any, solution_str: str, ground_truth: str, extra_info: Optional[Dict] = None) -> float:
    ...
    - Level 2: MAE reward (0-1) only if format is correct
    ...
    # Level 2: Compute MAE reward
    mae_reward = compute_mae_reward(predicted_dist, ground_truth, threshold=MAE_THRESHOLD)
