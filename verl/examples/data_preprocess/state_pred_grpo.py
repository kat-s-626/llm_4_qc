...
def format_prompt(data_item: Dict[str, Any], eos_token: str = "") -> Dict[str, str]:
   ...
   # Extract required fields
    ...
    if len(probability_distribution) > 15:
        # Sort by probability and keep top-15
...
def process_dataset(data: List[Dict[str, Any]], split: str, data_source: str) -> List[Dict[str, Any]]:
    ...
    for idx, item in enumerate(data):
        # Format using prompt template 7
        ...
        # Create the processed data item in the same format as gsm8k.py
        processed_item = {
            ...
            "ability": "quantum_simulation",  
            "reward_model": {
                "style": "rule",
                "ground_truth": json.dumps(msb_measurement_probabilities)  
            },
            DATASET_EXTRA_INFO: {
...
def main():
    ...
    parser.add_argument("--train_split", type=float, default=1.0, help="Fraction of data for training (default: 0.9)")
    parser.add_argument("--data_source", default="quantum_circuits/state_pred", help="Data source identifier")
